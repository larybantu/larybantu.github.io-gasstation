...
<div id="wrapper">
    ...
    <form  id="formID" name="invoice" method="post" action="change_price_admin.php">
    <table width="552">
      <tr>
      ...
      <tr>   
       <td height="36" class="rightalign">PMS:</td>
        <td>
          <?php 
			$querycurrent = mysql_query("SELECT MAX(date_of_change), current_price, product_code FROM pump_price WHERE product_code='PMS' LIMIT 1");
			...
			if($_POST['date'] != NULL && 
			   ...
			   $_POST['product'] != NULL){
					...
					$query = "INSERT INTO pump_price(date_of_change, date_of_entry, product_code, current_price, old_price)
					 VALUES('{$date}',CURDATE(),'{$product}',{$change_price}, {$old_price})";
