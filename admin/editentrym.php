...
<div id="wrapper">
  ...
  <div id="display">
    <div class="menuhead">Meter Transaction Entry</div>
     <form  id="formID" name="meter" method="post" action="<?php echo "update_meter.php?meter_id=". urlencode($editmeter['meter_transaction_id']) .""?>">
    <table width="658">
      <tr>
        ...
        <tr>  
          <td>Opening Meter:</td>
           ...
           <td class="del"><a href="<?php 
			 	echo "delete_meter_entry.php?meter_id=". urlencode($editmeter['meter_transaction_id']) ."";
